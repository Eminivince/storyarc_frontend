            ...
            >
              <section className="flex flex-col gap-6">
                ...
                <div className="max-w-md">
                  <label className="flex flex-col gap-2">
                    ...
                    <select
                      className="h-12 rounded-lg border border-slate-300 bg-slate-50 px-4 text-slate-900 transition-all focus:border-primary focus:ring-primary dark:border-primary/20 dark:bg-background-dark dark:text-white"
              ...
              <section className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="group relative">
                    ...
                    <input
                      className="block h-12 w-full rounded-lg border border-slate-300 bg-slate-50 pl-12 pr-4 text-slate-900 transition-all placeholder:text-slate-400 focus:border-primary focus:ring-primary dark:border-primary/20 dark:bg-background-dark dark:text-white dark:placeholder:text-slate-600"
              ...
              <section className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    className="block w-full resize-none rounded-lg border border-slate-300 bg-slate-50 p-4 text-base text-slate-900 transition-all placeholder:text-slate-400 focus:border-primary focus:ring-primary dark:border-primary/20 dark:bg-background-dark dark:text-white dark:placeholder:text-slate-600"
    ...
    <div className="min-h-screen bg-background-light font-display text-slate-900 dark:bg-background-dark dark:text-slate-100 md:hidden">
      <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-light dark:bg-background-dark">
        <header className="flex items-center justify-between p-4 pb-2">
          <Link className="flex size-12 items-center justify-center text-primary" to="/creator">
        ...
        <div className="flex flex-col gap-3 p-4">
          <div className="flex justify-between gap-6">
            <p className="text-base font-medium">Step 2 of 5</p>
            <p className="text-sm font-bold text-primary">40% Complete</p>
          </div>
          <div className="h-2 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-primary/20">
            <div className="h-full rounded-full bg-primary" style={{ width: "40%" }} />
          </div>
        </div>

        <div className="px-4 pt-5">
          <h3 className="text-2xl font-bold leading-tight">Application Form</h3>
        ...
        <form className="flex flex-col gap-6 p-4" onSubmit={onSubmit}>
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                className="h-14 rounded-lg border border-slate-300 bg-white p-4 text-base text-slate-900 placeholder:text-slate-400 focus:border-primary focus:ring-1 focus:ring-primary dark:border-primary/30 dark:bg-background-dark/50 dark:text-slate-100 dark:placeholder:text-slate-500"
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              {creatorMobileGenres.map((genre) => {
                ...
                return (
                  <button
                    className={`rounded-xl border p-4 font-semibold transition-colors ${
                      selected
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              {creatorExperienceLevels.map((level) => {
                ...
                return (
                  <button
                    className="flex items-center rounded-xl border border-slate-300 bg-white p-4 text-left transition-colors hover:border-primary/60 dark:border-primary/20 dark:bg-background-dark/50"
                    key={level.id}
                    onClick={() => onExperienceSelect(level.id)}
                    type="button"
                  >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                className="min-h-[140px] resize-none rounded-lg border border-slate-300 bg-white p-4 text-base text-slate-900 placeholder:text-slate-400 focus:border-primary focus:ring-1 focus:ring-primary dark:border-primary/30 dark:bg-background-dark/50 dark:text-slate-100 dark:placeholder:text-slate-500"
                onChange={onChange("motivation")}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-slate-300 bg-white p-8 text-center dark:border-primary/30 dark:bg-background-dark/30">
              ...
              <button className="mt-2 rounded-full border border-primary px-6 py-2 text-sm font-bold text-primary" type="button">
                Browse Files
              </button>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-col gap-4 pb-10">
            <button
              className="h-16 rounded-xl bg-primary text-lg font-bold text-background-dark shadow-lg shadow-primary/20 transition-transform active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
              disabled={isSaving || isSubmitting}
              type="submit"
            >
              {isSubmitting ? "Submitting..." : "Submit Application"}
            ...
            <button
              disabled={isSaving || isSubmitting}
              className="h-12 rounded-xl bg-transparent text-base font-medium text-slate-500 dark:text-slate-400"
              onClick={onSaveDraft}
              type="button"
            >
              {isSaving ? "Saving Draft..." : "Save Draft and Exit"}
        ...
        <div className="h-10 bg-gradient-to-t from-primary/10 to-transparent" />
      </div>
    </div>
  );
}
